import{E as _,o as g}from"./VertexArrayObject-DulQagr-.js";import{x as j,s as F}from"./FramebufferObject-BS2zNKUU.js";import{r as c}from"./ProgramTemplate-rbh8Cw0m.js";import{e as O,a as P}from"./ProgramTemplate-rbh8Cw0m.js";import{ds as A}from"./index-CZ5hE8fp.js";import{t as p}from"./NestedMap-GuqgquCN.js";import"./memoryEstimations-B6bMMgTZ.js";class ${constructor(e){this._rctx=e,this._store=new p}dispose(){this._store.forAll(e=>e.dispose()),this._store.clear()}acquire(e,t,o,n){const r=this._store.get(e,t);if(r!=null)return r.ref(),r;const s=new c(this._rctx,e,t,o,n);return s.ref(),this._store.set(e,t,s),s}get test(){}}function l(i){const{options:e,value:t}=i;return typeof e[t]=="number"}function x(i){let e="";for(const t in i){const o=i[t];if(typeof o=="boolean")o&&(e+=`#define ${t}
